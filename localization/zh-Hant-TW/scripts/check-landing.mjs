...
expect(indexHtml.includes('rel="canonical" href="https://roost.mashbean.net/"'), "custom-domain canonical URL is missing");
expect(indexHtml.includes('property="og:url" content="https://roost.mashbean.net/"'), "custom-domain Open Graph URL is missing");
expect(indexHtml.includes("mashbean 維護的非官方繁中社群版本"), "unofficial community-version disclosure is missing");
