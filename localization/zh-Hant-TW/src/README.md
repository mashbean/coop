<div class="coop-landing">
  ...
  <section class="landing-hero" aria-labelledby="landing-title">
    <div class="landing-hero-copy">
      ...
      <h1 id="landing-title">小型社群，也能自己架起內容治理工具</h1>
      <p class="landing-lead">Coop 把檢舉、規則、人工審查、處置與申訴放在同一套開源系統。這裡提供台灣繁體中文文件，方便管理者、志工與工程團隊查功能、看限制，再評估是否適合導入。</p>
    ...
    <figure class="landing-product-shot">
      ...
      <figcaption>規則、審查 Queue 與紀錄都留在自行管理的基礎設施。</figcaption>
    </figure>
  </section>
  ...
  <section class="landing-section landing-ecosystem-section" aria-labelledby="landing-ecosystem-title">
    <div class="landing-section-heading">
      ...
      <h2 id="landing-ecosystem-title">ROOST 各項工具分別處理哪一段</h2>
      <p>DIRE 把工作分成偵測、調查、審查與執行。社群可以先找目前缺少的那一段，不必一次導入整套工具。</p>
    </div>
    <ol class="landing-dire" aria-label="DIRE 安全治理流程">
      <li>
        <span class="landing-dire-letter">D</span>
        <div><small>Detection</small><strong>偵測</strong><p>用模型、雜湊比對或平台 Signals 找出待處理的內容與行為。</p></div>
      </li>
      <li>
        <span class="landing-dire-letter">I</span>
        <div><small>Investigation</small><strong>調查</strong><p>用 Osprey 查事件、帳號關係與協同行為，並整理成規則。</p></div>
      </li>
      <li>
        <span class="landing-dire-letter">R</span>
        <div><small>Review</small><strong>審查</strong><p>Coop 把案件送進指定 Queue，讓審查人員查看脈絡並留下決定。</p></div>
      </li>
      <li>
        <span class="landing-dire-letter">E</span>
        <div><small>Enforcement</small><strong>執行</strong><p>Action 把自動或人工決定送回平台，申訴與稽核紀錄則留在 Coop。</p></div>
      </li>
    </ol>
  ...
  <section class="landing-section" aria-labelledby="landing-paths-title">
    <div class="landing-section-heading">
      ...
      <h2 id="landing-paths-title">現在要處理哪一件事</h2>
      <p>依照手上的工作選入口，不用先讀完整套文件。</p>
    </div>
    <div class="landing-path-grid">
      <a class="landing-path-card landing-path-coral" href="user/">
        ...
        <h3>社群管理與內容審查</h3>
        <p>先查 Item、Policy、Rule、Queue、Decision 與 Action 分別代表什麼。</p>
      ...
      <a class="landing-path-card landing-path-teal" href="api/">
        ...
        <h3>產品與平台整合</h3>
        <p>查內容提交、檢舉、申訴、Partial Items 與 Action callback 的接法。</p>
      ...
      <a class="landing-path-card landing-path-blue" href="development/">
        ...
        <h3>工程、資安與維運</h3>
        <p>查本機開發、驗證、Docker、部署、系統架構與資料倉儲。</p>
      ...
      <a class="landing-path-card landing-path-gold" href="integrations/">
        ...
        <h3>Signals 與外部服務</h3>
        <p>核對 HMA、NCMEC、Google、OpenAI、CoPE 與自訂整合的資料流和限制。</p>
  ...
  <section class="landing-section landing-flow-section" aria-labelledby="landing-flow-title">
    <div class="landing-section-heading">
      <p class="landing-kicker">Coop 處理流程</p>
      <h2 id="landing-flow-title">一則檢舉進來後，系統怎麼走</h2>
      <p>Coop 會保存自動規則、人工決定、平台處置、申訴與稽核紀錄。</p>
    </div>
    <ol class="landing-flow">
      <li><span>01</span><div><strong>接收內容與檢舉</strong><p>平台提交 Items，使用者 Reports 帶入需要處理的脈絡。</p></div></li>
      <li><span>02</span><div><strong>規則評估與路由</strong><p>Signals 與 Rules 直接處理案件，或把工作送進指定 Queue。</p></div></li>
      ...
      <li><span>05</span><div><strong>申訴與稽核</strong><p>保存決策紀錄並處理 Appeals，之後可以查回原決定與覆核結果。</p></div></li>
    </ol>
  </section>
  ...
  <section class="landing-safety" aria-labelledby="landing-safety-title">
    ...
    <div>
      ...
      <h2 id="landing-safety-title">導入前要另外確認法律、權限與資料處理</h2>
  ...
  <section class="landing-final-cta" aria-labelledby="landing-cta-title">
    <p class="landing-kicker">下一步</p>
    <h2 id="landing-cta-title">先看 Coop 的資料模型與審查流程</h2>
    <p>從基本概念開始，或直接開啟完整目錄查需要的章節。</p>
