...
Coop 使用 Queue 組織審查 Job。內容遭到檢舉後，無論來源是平台使用者或[主動式規則](https://roostorg.github.io/coop/latest/user/automated-enforcement.html#proactive-rules)，都會進入 Queue，直到完成審查並作成決策。
...
[Routing Rules](https://roostorg.github.io/coop/latest/user/automated-enforcement.html#routing-rules) 決定新進 Job 要送到哪個 Queue。
...
- 已為相關 Item Type 設定的**[自訂 Action](https://roostorg.github.io/coop/latest/user/administration.html#actions)**，但不包含目前 Queue 隱藏的項目
