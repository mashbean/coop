...
你可以在自己的基礎設施上執行 Coop。另請參考 [Docker Images](docker.md) 與英文版 [architecture information](https://roostorg.github.io/coop/latest/development/architecture.html)。
...
- Analytics 與 warehouse backend 由 `WAREHOUSE_ADAPTER` 和 `ANALYTICS_ADAPTER` 控制。支援的 adapter 及相關 ClickHouse/PostgreSQL 設定，請參考英文版 [Data Warehouse Abstraction Layer](https://roostorg.github.io/coop/latest/development/data-warehouse.html)。
